...
/*
 * Метод: unordered()
 * Назначение: Указывает, что порядок элементов после операции
 * не имеет значения.
*/
    public static void main(String[] args) {

// Пример 1. Использование метода unordered() без параметров.
// Создаем коллекцию чиселЖ
        ...
        // Результат: порядок вывода элементов может быть случайным, но все элементы
