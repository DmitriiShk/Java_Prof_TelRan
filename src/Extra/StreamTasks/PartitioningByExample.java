...
public class PartitioningByExample {
    ...
    /**
     * Метод partitioningBy() разделяет элементы коллекции на две
     * группы в соответствии с заданным условием. В данном примере
     * будем разделять список чисел на четные и нечетные числа.
     */
    public static void main(String[] args) {
        ...
        //evenOddPartition.forEach((key, value) -> System.out.println(key + ": " + value));
        // Выводим результат
