...
public class MapExamples {
    ...
    public static void main(String[] args) {
        ...
        int sum = numbers.stream().map(num -> num + 10)
                        .reduce(5, Integer::sum);
        // Выводим результат
        System.out.println("\nСумма чисел с добавлением 10 и начальным значением 5: " + sum);
        ...
        // Применяем map() для преобразования каждой строки: первая буква заглавная,
        // затем в нижнем регистре
        List<String> modifiedWords = words.stream()
                ...
                .toList();
        // Выводим результат
        System.out.println("\nМодифицированные слова: " + modifiedWords);
